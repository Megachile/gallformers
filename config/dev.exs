...
config :gallformers, GallformersWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:gallformers, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:gallformers, ~w(--watch)]}
  ]
...
config :gallformers, GallformersWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/gallformers_web/router\.ex$",
      ~r"lib/gallformers_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
